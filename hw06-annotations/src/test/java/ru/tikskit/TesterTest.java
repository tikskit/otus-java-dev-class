...
class TesterTest {
    ...
    @Test
    void oneTestPassed() {
        assertDoesNotThrow(() -> tester.doTest("ru.tikskit.hwtests.OneTestPassedHWTest", new PrintStream(out)));
    ...
    @Test
    void oneTestFailed() {
        assertDoesNotThrow(() -> tester.doTest("ru.tikskit.hwtests.OneTestFailedHWTest", new PrintStream(out)));
    ...
    void oneTestPassedOneFailed() {
        assertDoesNotThrow(() -> tester.doTest("ru.tikskit.hwtests.OneTestPassedOneFailedHWTest", new PrintStream(out)));
